...
10. [x] Estatísticas de pacing: separar tempo ativo, descanso real, descanso planejado, ritmo ativo e ritmo total por repetição.
11. Ritmo por grupo de sets: ritmo-base com ajustes opcionais por grupo e fotografia do plano no treino salvo.
12. Meta total de sessão: calcular ritmo-base e duração dos blocos a partir do tempo total desejado, descansos e multiplicadores por grupo; indicar projeção em modos de descanso manual.
