...
14. [x] Temas e cores: modo claro, escuro ou automático, nove paletas de acento independentes e opção de aplicá-las (ou não) nos gráficos e calendário, com preferência salva localmente.
