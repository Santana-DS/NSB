...
8. Temas e cores: selecionar paletas de visualização e oferecer modo claro, escuro ou automático conforme a preferência do sistema.
9. Baixa prioridade — Idioma geral do aplicativo: tela de configurações para alternar entre português, inglês e espanhol, com preferência salva localmente.
