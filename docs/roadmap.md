...
14. [~] Temas e cores: modo claro, escuro ou automático conforme a preferência do sistema foi iniciado. Paletas independentes para visualizações permanecem como evolução futura.
